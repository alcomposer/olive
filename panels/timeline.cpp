...
QString make_list_clips(const std::vector<Clip*> clips_selected){
    QString rtn = "\n";
...
void Timeline::set_marker() {
	...
	if (!add_marker) {
        ...
        d.setLabelText(clip_mode? tr("Set marker name for clip: ") + make_list_clips(clips_selected) : tr("Set marker name for sequence"));
